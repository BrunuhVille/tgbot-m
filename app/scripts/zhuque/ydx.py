...
async def zhuque_ydx_check(client: Client, message: Message):
    ...
    global bet_bouns, high_times, low_times, bet_point, bet_switch, bet_mode, rele_betbouns, lose_times, win_times, sum_losebouns, add_bet_times, kp_switch
    ...
    if bet_switch == 1:
        ...
        if bet_point != 0:
            if Lottery_Point == bet_point:
                ...
                win_times = 0
                add_bet_times = 0
            bet_bouns = int(sum_losebouns / 0.99) + start_bouns*(lose_times+1)
